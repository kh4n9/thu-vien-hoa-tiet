...
export function SiteFooter() {
  return (
    <footer className="texture-lacquer border-t border-lacquer-line/60">
      <div className="mx-auto max-w-6xl px-4 py-14">
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="font-display text-lg text-lacquer-fg">Thư viện Họa Tiết</span>
            </div>
            <p className="text-sm leading-relaxed text-lacquer-soft">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-lacquer-soft">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-2 border-t border-lacquer-line/50 pt-6 text-xs text-lacquer-soft/70 sm:flex-row">
